 ...
 */
final class Version20230626150117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, phone VARCHAR(20) NOT NULL, logo VARCHAR(255) DEFAULT NULL, siret VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_4FBF094FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE joboffer (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, job_id INT DEFAULT NULL, contract_id INT DEFAULT NULL, salary_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, city VARCHAR(50) NOT NULL, salary_min INT NOT NULL, salary_max INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_F33F8164979B1AD6 (company_id), INDEX IDX_F33F8164BE04EA9 (job_id), INDEX IDX_F33F81642576E0FD (contract_id), INDEX IDX_F33F8164B0FDF16E (salary_id), FULLTEXT INDEX IDX_F33F81642B36786B2D5B0234 (title, city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
